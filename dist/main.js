...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _gameName_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./gameName.js */ \"./src/gameName.js\");\n\r\n\r\nconst getGameId = async () => {\r\n  const gameName = await gameName();\r\n  const resultArray = _gameName_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"].split(' ');\r\n  let gameId = '';\r\n  for (let i = 0; i < resultArray.length; i += 1) {\r\n    if (resultArray[i].length > gameId.length) {\r\n      gameId = resultArray[i];\r\n    }\r\n  }\r\n  localStorage.setItem('gameId', gameId);\r\n  return gameId;\r\n};\r\n\r\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getGameId);\n\n//# sourceURL=webpack://webpack_template/./src/gameId.js?");
...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\nconst generateGameName = async () => {\r\n    const result = await fetch(\r\n      'https://us-central1-js-capstone-backend.cloudfunctions.net/api/games/',\r\n      {\r\n        method: 'POST',\r\n        body: JSON.stringify({\r\n          name: 'mountain race',\r\n        }),\r\n        headers: {\r\n          'Content-type': 'application/json; charset=UTF-8',\r\n        },\r\n      },\r\n    );\r\n  try {\r\n    if (result.ok) {\r\n        const data = await result.json();\r\n        const name = data.result;\r\n        return name;\r\n      }\r\n      return 'error';\r\n    \r\n  }catch(error){\r\n    return error;\r\n  }\r\n    \r\n  };\r\n  \r\n  /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (gameNamed);\n\n//# sourceURL=webpack://webpack_template/./src/gameName.js?");

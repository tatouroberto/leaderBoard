...
[**LEADERBOARD**](https://github.com/tatouroberto/leaderBoard) is a website to View list of scores.
...
```sh
git git@github.com:tatouroberto/leaderBoard.git
```
...
Feel free to check the [issues page](https://github.com/tatouroberto/leaderBoard/issues).
